    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Category != null ? 
                          ...
                          Problem("Entity set 'ProjectDbContext.Category'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjectDbContext.Category'  is null.");
            }
            var category = await _context.Category.FindAsync(id);
            if (category != null)
            {
        ...
        public async Task<IActionResult> Search(string keyword)
        {
            ...
            var searchResults = await _context.Category
                .Where(c => c.Name.Contains(keyword) || c.Type.Contains(keyword) || c.Description.Contains(keyword))
                .ToListAsync();
